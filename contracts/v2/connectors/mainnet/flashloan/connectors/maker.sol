...
contract BasicResolver is MakerHelpers {
    ...
    constructor(address _mappingaddr)MakerHelpers(_mappingaddr){}
    ...
    */
    function deposit(uint vault, uint amt) external payable
    {
        ...
        address colAddr = InstaMappingInterface(getMappingAddr()).gemJoinMapping(ilk);
...
contract ConnectMaker is  BasicResolver {
    constructor(address _mappingaddr)BasicResolver(_mappingaddr){}
